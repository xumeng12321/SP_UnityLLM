...
namespace LLMUnity
{
    ...
    public class LLMClient : MonoBehaviour
    {
        ...
        [TextArea(15, 80), Chat] public string prompt = "A chat between a curious human and an artificial intelligence assistant. The assistant gives helpful, detailed, and polite answers to the human's questions.";

        [Chat]
        public LLMMethods methods;
        ...
        /// <summary>
        /// Handles a chat message by the user and retrieves the answer asynchronously.
        /// </summary>
        /// <param name="question">The question to be asked.</param>
        /// <param name="callback">Optional callback function to be called while the answer is received.</param>
        /// <param name="completionCallback">Optional callback function to be called when the answer is fully received.</param>
        /// <param name="addToHistory">Flag indicating whether to add the question and answer to the chat history.</param>
        /// <returns>The answer received from the chat.</returns>
        ...
        public async Task<List<int>> Tokenize(string question, Callback<List<int>> callback = null)
        {
            ...
            Debug.Log("TOKENIZECALLED");
            Debug.Log("TOKENIZE QUESTION: " + question);
